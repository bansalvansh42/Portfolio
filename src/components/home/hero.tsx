    ...
    <section className="relative min-h-[85vh] md:min-h-[80vh] flex items-center">
      <div className="container pt-16 md:pt-20">
        <div className="max-w-2xl">
          ...
          >
            <h1 className="text-xs text-muted-foreground tracking-[0.2em] uppercase mb-5 font-mono">
              {personalInfo.name}
            </h1>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight mb-5 leading-[1.15]">
